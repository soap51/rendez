...
import { ActivityIndicator, Image, ImageBackground, KeyboardAvoidingView, StyleSheet, Text, TextInput, TouchableOpacity, View } from 'react-native';
            ...
            <ImageBackground source={DFD} style={{ width: '100%', height: "100%" }}>
                <View style={styles.back}>
                    <KeyboardAvoidingView behavior="position" enabled>
                        ...
                        <Text style={{
                            color: "white", fontSize: Circle.sizeOfCircle * 0.5,
